 ...
 *     summary="Retrieve a list of holiday plans",
 *     operationId="getHolidayPlans",
 *     tags={"Holiday Plans"},
 *     security={{"bearerAuth": {}}},
 *     @OA\Response(
 *         response=200,
 *         description="Holiday plans retrieved successfully",
 *         @OA\JsonContent(
 *             type="object",
 *             @OA\Property(
 *                 property="message",
 *                 type="string",
 *                 example="Holiday plans retrieved successfully."
 *             ),
 *             @OA\Property(
 *                 property="data",
 *                 type="array",
 ...
 *     @OA\Response(
 *         response=204,
 *         description="No holiday plans found",
 *         @OA\JsonContent(
 *             type="object",
 *             @OA\Property(
 *                 property="message",
 *                 type="string",
 *                 example="No holiday plans found."
 *             ),
 *             @OA\Property(
 *                 property="data",
 *                 type="array",
