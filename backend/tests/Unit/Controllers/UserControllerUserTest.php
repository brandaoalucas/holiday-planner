...
class UserControllerUserTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function testGetAllReturns204EmptyArray()
    {
    ...
    public function testFindByIdReturns404WhenUserIsNotTheAuthenticatedUser()
    {
    ...
    public function testFindByIdTrashedReturns404WhenSoftDeletedUserIsNotTheAuthenticatedUser()
    {
    ...
    public function testUpdateReturns404IfUserIsNotTheAuthenticatedUser()
    {
    ...
    public function testDeleteReturn404IfSoftDeletedUserIsNotAuthenticatedUser()
    {
        $user = User::factory()->create(['deleted_at' => now()->addDay()]);
        $response = $this->deleteJson(route('users.delete', ['id' => $user->id]));
        $response->assertStatus(404);
    ...
    public function testRestoreReturns404IfSoftDeletedUserIsNotTheAuthenticatedUser()
    {
        $user = User::factory()->create(['deleted_at' => now()->addDay()]);
    ...
    public function testRestoreReturns404IfUserDoesNotExistes()
    {
    ...
    public function testGetAllOnlyTrashedReturnEmptyArrayIfAuthenticatedUserRoleIsNotAdmin()
    {
        User::factory()->count(2)->create(['deleted_at' => now()->addDay()]);
    ...
    public function testGetAllOnlyTrashedReturnEmptyArrayIfNoUsersWasSoftDeleteed()
    {
